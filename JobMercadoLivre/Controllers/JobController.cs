...
namespace JobMercadoLivre.Controllers
{
    ...
    public class JobController : ControllerBase
    {
        public void Autenticacao()
        {
            //PostToken();
            //PedidoMLB();
            //Buscar_Os_Pedidos_De_Um_Vendedor();
            //ConsultarDadosPessoais();
            //ChecarSaldoEmConta();
            //NotasDeOrdem();
            //PagamentosAceitosPeloVendedor();
            //AddNovoProtudo();
            //EditarPreco();
            //EditarQuantidadeEstoque();
            //AlterarVideo();
            //AlterarCategoriaDoProduto();
            //AlterarTituloAnuncio();
            //AlterarUnidadeEmarca();
            //SemGarantia();
            //AlterarGarantiaFabricanteEvendedor();
        }
